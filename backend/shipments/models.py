...
class Shipment(TimeStampedModel):
    ...
    forwarder = models.CharField(max_length=255, blank=True, help_text='Freight Forwarder')
    cha = models.CharField(max_length=255, blank=True, help_text='Customs House Agent')
