          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
              ...
              <div className="flex items-center gap-2">
                <a href={pdfPreviewUrl} download={`COA_${form.product_name.replace(/\s/g, "_")}.pdf`} className="px-3 py-1.5 bg-indigo-600 text-white text-xs rounded-lg hover:bg-indigo-700">Download</a>
            ...
            <div className="flex-1 overflow-auto bg-gray-50">
              <iframe src={pdfPreviewUrl} className="w-full h-[78vh] border-0" />
            </div>
          </div>
        </div>
      )}
